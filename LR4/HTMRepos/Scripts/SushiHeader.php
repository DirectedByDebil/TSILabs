        ...
        <div class="container-lg">
            <div class="fs-6 px-4">
                <div class="d-flex flex-row justify-content-sm-start align-items-center ">
                    <div class="p-3"> <a href="SushiMain.php"> <img
...
<div class="container-sm  text-bg-dark rounded img-thumbnail">
    <div class="fs-5 px-4">
        <div class="d-flex flex-row justify-content-sm-start align-items-center ">
            ...
            <div class="p-3 me-auto"> <a style="color: #198754" href="SecretPage.php">Секретная страница</a></div>
            <div class="p-3">Изменить</div>
            <div class="p-3">Доставка</div>
