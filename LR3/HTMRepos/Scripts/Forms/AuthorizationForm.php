        ...
        <div class="fs-6 ">
            <div class="d-inline-flex flex-column justify-content-sm-center rounded">
                ...
                <div class="p-1">
                    ...
                    <input type="email" name="login" id="login" placeholder="Логин или адрес электронной почты" class="w-100" autocomplete="on" value="<?php $authorization->GetLogin();?>" > </div>
                <div class="p-1">
                    <label for="password">Пароль</label>
                    <input type="password" name="password" id="password" placeholder="Пароль" class="w-100" value="<?php $authorization->GetPassword();?>" > </div>
